...
from wiviz_sim import HEATMAP_HEIGHT, MAX_PATH_ROWS, RSS_SPOT_RADIUS_M, point_in_box_xy  # noqa: E402
...
def main():
    ...
    for c in CONDITIONS:
        ...
        if rows and abs(strongest_rel) > 1e-6:
            fail(f"{n}: strongest path relative power is {strongest_rel}, expected 0.0000")
